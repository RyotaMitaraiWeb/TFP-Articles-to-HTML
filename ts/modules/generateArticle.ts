export function generateArticle(article: string, spotlight: boolean, twoSets: boolean,
    threeSets: boolean, script: boolean, stats: boolean): string {

    let style: string = '', scriptSrc: string = '';
